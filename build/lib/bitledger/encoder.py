...
# SF index 0..17: ×10^index (TECHNICAL_OVERVIEW scaling table; indices 10–17 follow same pattern).
SCALING_FACTORS: tuple[Decimal, ...] = tuple(Decimal(10**i) for i in range(18))
